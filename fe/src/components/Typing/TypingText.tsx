...
function TypingText({ text, speed = 30, chunkSize = 3, onDone, ...textProps }) {
  ...
  useEffect(() => {
    if (!text) {
      setDisplayedText('');
      setIsComplete(true);
      // return undefined ro rang: nhanh duoi tra ve ham cleanup, nen
      // useEffect nay co hai kieu tra ve. React cho phep ca hai, nhung
      // viet ro thi noImplicitReturns khong phai doan.
      return undefined;
    }

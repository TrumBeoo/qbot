...
interface SocialLoginButtonsProps {
  onGoogleSuccess: (credentialResponse: { credential: string }) => void | Promise<void>;
  onFacebookSuccess: (facebookData: unknown) => void | Promise<void>;
...
const SocialLoginButtons = ({
  ...
  const handleGoogleLogin = useCallback(() => {
    if (window.google) {
      ...
      setTimeout(() => {
        // querySelector tra ve Element, ma Element khong co .click().
        // Chi HTMLElement moi co, nen chi ro kieu o day.
        const googleButton = buttonDiv.querySelector<HTMLElement>('div[role="button"]');
        if (googleButton) {
          googleButton.click();
        }

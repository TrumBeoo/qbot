...
const ChatInput = ({
 ...
 const {
  ...
  // Thieu tham so thu hai: useColorModeValue(light, dark). Ban cu chi
  // truyen mot gia tri nen o dark mode tra ve undefined, va <Flex bg={bgColor}>
  // o duoi khong co mau nen. Cac dong ke ben deu truyen du hai.
  // gray.900 chon theo cap voi inputContainerBg (white / gray.800) - doi
  // duoc neu ban muon tone khac.
  const bgColor = useColorModeValue('#f7f7f8', 'gray.900');
        ...
        >
         ...
         <Textarea
          ...
          <Tooltip label={translations[language].sendMessage}>
            <IconButton
               icon={<HiArrowUp />}
              // aria-label bat buoc: nut chi co icon nen trinh doc man hinh
              // khong co gi de doc. Chakra khai bao required dung ly do do.

...
import type { AuthOutcome, Conversation, User } from '../../types/api';
import {
  Box,
  VStack,
  HStack,
...
interface SidebarProps {
  ...
  /** App.tsx truyen prop nay nhung Sidebar khong dung tới. */
                ...
                <Menu>
                  <MenuButton as={Button} variant="ghost" w="full" p={2}>
                    <HStack spacing={3} w="full">
                      {/* profile_picture, khong phai avatar: API khong co field `avatar`
                          nen anh dai dien truoc day khong bao gio tai duoc,
                          luon rot ve chu cai dau tu `name`. */}
                      <Avatar size="sm" name={user.name} src={user.profile_picture ?? undefined} />

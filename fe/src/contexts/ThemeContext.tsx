...
/**
 * Kieu doc TRUC TIEP tu object `themeValues` ben duoi, khong doan.
 * Them field vao themeValues thi phai them o day - neu khong, moi component
 * doc field do se bao loi, va do la dieu mong muon.
 */

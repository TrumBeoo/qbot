...
class VoiceApiService {
 // Khai bao field: gan trong constructor la du voi JS, TS thi can khai bao.
 ...
 _getHeaders(includeAuth = true) {
   // Record<string,string> thay vi de TS suy ra hinh dang co dinh:
   // Authorization duoc them co dieu kien ngay ben duoi.
 ...
 async voiceChat(text, languageHint = null, conversationId = null) {
   try {
     ...
     // Cung ly do: language va conversation_id duoc them co dieu kien.

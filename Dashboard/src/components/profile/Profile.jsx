        ...
        <Grid item xs={12} md={4}>
          <Card elevation={1} sx={{ height: 'fit-content' }}>
            <CardContent sx={{ textAlign: 'center', py: 4 }}>
              ...
              >
                {user?.businessInfo?.businessName?.charAt(0) || user?.email?.charAt(0) || 'A'}
              </Avatar>
              
              <Typography variant="h5" gutterBottom fontWeight="bold">
                {user?.businessInfo?.businessName || 'Admin User'}
              </Typography>
              ...
              <Stack spacing={2}>
                <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                  ...
                  <Typography variant="body2" color="text.secondary">
                    {user?.lastLoginAt ? new Date(user.lastLoginAt).toLocaleDateString('vi-VN') : 'Chưa có'}
                  </Typography>
                </Box>
                      ...
                      {isEditing ? (
                        ...
                        <>
                          ...
                          <Typography variant="body1" fontWeight="medium">
                            {user?.businessInfo?.businessName || 'Chưa cập nhật'}
                          </Typography>
                        </>
                      )}
                    </Box>
                    ...
                    <Box sx={{ flex: 1 }}>
                      {isEditing ? (
                        ...
                        <>
                          ...
                          <Typography variant="body1" fontWeight="medium">
                            {user?.businessInfo?.businessType || 'Chưa cập nhật'}
                          </Typography>
                        </>
                      )}
                    </Box>
                    ...
                    <Box sx={{ flex: 1 }}>
                      {isEditing ? (
                        ...
                        <>
                          ...
                          <Typography variant="body1" fontWeight="medium">
                            {user?.businessInfo?.contactPhone || 'Chưa cập nhật'}
                          </Typography>
                        </>
                      )}
                    </Box>
